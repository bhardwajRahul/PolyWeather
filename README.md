...
- Forecast API live: `https://api.polyweather.top/api/v1/forecasts` returns per-city DEB prediction, peak time, and hourly temperature curves for a 24-city default watchlist (entitlement-token auth); results are cached for 5 minutes.
